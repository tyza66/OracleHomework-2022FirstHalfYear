...
/**
 * Servlet implementation class BumenAddServlet
 */
@WebServlet("/bumen/add.do")
public class BumenAddServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public BumenAddServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int code = bumenServlet.bumenAdd(b);
		response.getWriter().print(code+"条数据被增加");
	}
