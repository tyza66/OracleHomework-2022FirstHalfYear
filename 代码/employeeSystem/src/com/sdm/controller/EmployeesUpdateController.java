...
/**
 * Servlet implementation class EmployeesUpdateController
 */
@WebServlet("/employees/update.do")
public class EmployeesUpdateController extends HttpServlet {
     ...
     */
    public EmployeesUpdateController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int code = employeesService.employeeUpdate(e);
		if(code == 0) {
			request.setAttribute("updatetip", "修改失败");
			request.getRequestDispatcher("employeesUpdate.jsp").forward(request, response);
		}else {
