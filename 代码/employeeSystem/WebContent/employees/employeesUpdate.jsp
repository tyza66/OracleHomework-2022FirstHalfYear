...
<body>
	<form action="/employeeSystem/employees/update.do"> 
		<p><input type="text" name="employeeid" placeholder="请输入要修改的员工编号"></p>
	...
	<%
		String updatetip = (String) request.getAttribute("updatetip");
		if (updatetip != null) {
	%>
	<h6><%=updatetip%></h6>
	<%
