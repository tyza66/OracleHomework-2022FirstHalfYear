...
<body>
	...
	<div id="app">
		...
		<div class="righttab">
			...
			<el-table stripe :data="tableData" border style="width: 100%">
				<el-table-column prop="id" label="蔬菜ID" width="180"></el-table-column> 
				<el-table-column prop="type" label="蔬菜种类"> </el-table-column> 
				<el-table-column prop="number" label="剩余量"> </el-table-column>
			    <el-table-column prop="place" label="放置地点"> </el-table-column>
		...
		<el-dialog title="新增菜品" :visible.sync="dialogVisible" width="30%" :before-close="handleClose"> 
				<el-form :label-position="labelPosition" label-width="80px" :model="formLabelAlign"> 
					...
					<el-form-item label="剩余量"> <el-input
						v-model="formLabelAlign.number"></el-input>
				    </el-form-item> 
		...
		<el-dialog title="编辑菜品" :visible.sync="dialogVisible2" width="30%":before-close="handleClose2"> 
				<el-form :label-position="labelPosition2" label-width="80px":model="formLabelAlign2"> </el-input> </el-form-item>
						...
						<el-input v-model="formLabelAlign2.number"></el-input> 
						</el-form-item> 
						
						<el-form-item label="放置地点"> 
						<el-input v-model="formLabelAlign2.place"></el-input>
						</el-form-item> 
				...
				<span slot="footer" class="dialog-footer"> 
						<el-button
								@click="dialogVisible2 = false;
										...
										formLabelAlign2.place = '';">取消
										
						</el-button> <el-button type="primary" @click="update()">确 定</el-button>
				</span> 
	...
	if (request.getAttribute("vlist") == null) {
		...
		app.putVegatable(<%=v.getVegetable_id()%>,
				'<%=v.getVegetable_kinds()%>',
				<%=v.getVegetable_number()%>,
				'<%=v.getVegetable_place()%>');
	<%}
				session.setAttribute("addstatus","");
			}%>
