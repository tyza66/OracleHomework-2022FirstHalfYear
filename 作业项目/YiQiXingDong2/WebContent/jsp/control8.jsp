...
<body>
	...
	<div id="app">
		...
		<el-main class="main"> <el-menu default-active="8"
			...
			class="el-icon-setting"></i> <span slot="title">管理者</span> </el-menu-item> <el-menu-item
		...
		<div class="righttab">
			...
			</el-table-column> <el-table-column prop="type" label="确诊时间"> </el-table-column> <el-table-column
				prop="number" label="病人姓名"> </el-table-column> <el-table-column
				prop="place" label="医生姓名"> </el-table-column> <el-table-column
				prop="number2" label="类别"> </el-table-column> <el-table-column
		...
		<el-dialog title="新增病例" :visible.sync="dialogVisible" width="30%"
			:before-close="handleClose"> <el-form
			:label-position="labelPosition" label-width="80px"
			:model="formLabelAlign"> <el-form-item label="病例ID">
		<el-input v-model="formLabelAlign.id"></el-input> </el-form-item> <el-form-item
			label="确诊时间"> <el-input v-model="formLabelAlign.type"></el-input>
		</el-form-item> <el-form-item label="病人姓名"> <el-input
			v-model="formLabelAlign.number"></el-input> </el-form-item> <el-form-item
			label="医生姓名"> <el-input v-model="formLabelAlign.place"></el-input>
		</el-form-item> <el-form-item label="所属类别"> <el-input
			v-model="formLabelAlign.number2"></el-input> </el-form-item></el-form> <span slot="footer" class="dialog-footer"> <el-button
		...
		<el-dialog title="编辑病例" :visible.sync="dialogVisible2" width="30%"
			...
			label="确诊时间"> <el-input v-model="formLabelAlign2.type"></el-input>
		</el-form-item> 
		<el-form-item label="病人姓名"> <el-input
			v-model="formLabelAlign2.number"></el-input> </el-form-item> <el-form-item
			label="医生姓名"> <el-input v-model="formLabelAlign2.place"></el-input>
		</el-form-item>
		<el-form-item label="类别"> <el-input
			v-model="formLabelAlign2.number2"></el-input> </el-form-item> </el-form> <span slot="footer" class="dialog-footer"> <el-button
	...
	<script src="../js/control8_main.js"></script>
	<script>
	...
	if (request.getAttribute("vlist") == null) {
				request.getRequestDispatcher("../Medical?t=1").forward(request, response);
			}
			List<Medical> list = (ArrayList) request.getAttribute("vlist");
			//判断空值
			if (list.size() == 0) {
			} else {
				for (Medical v : list) {%>
		app.putVegatable(<%=v.getId()%>,'<%=v.getTime()%>','<%=v.getPname()%>','<%=v.getDname()%>','<%=v.getClassify()%>');
	<%}
				session.setAttribute("addstatus","");
			}%>
