...
<body>
	<div id="app">
		...
		<div class="login">
			...
			<div class="user">
				<el-form :label-position="labelPosition" label-width="80px":model="userLogin">
					...
					<el-input type="​number" class="input" placeholder="从1、2、3、4、5里选" v-model="userLogin.ks"></el-input>
					</el-form-item> 
				
					<el-form-item label="密码"> 
					<el-input type="password"clearable class="input" placeholder="密码不可超过12个字符" v-model="userLogin.password"> </el-input> 
					</el-form-item>
				
					<el-form-item label="验证码"> <el-input type="text"clearable class="input2" v-model="userLogin.yanzheng"></el-input> 
				
						<el-image
							id="vc"
							style="width: 100px; height: 30px;position: absolute;top:5px;margin-left:5px;"
							src="${pageContext.request.contextPath}/vc" fit="fit">
						</el-image> 
						
						<a href="javascript:pic();"> 
							<i class="el-icon-refresh" style="position: relative; margin-left: 110px; margin-top: 2px;"
								@onclick="vc()">
							</i>
						</a> 
					</el-form-item> 
