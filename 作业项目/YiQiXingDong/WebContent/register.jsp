		...
		<div class="login">
			...
			<div class="user">
				...
				<el-input type="password" clearable class="input"
					v-model="userLogin.password"></el-input> </el-form-item> <el-form-item label="验证码">
				<el-input type="text" clearable class="input2"
					v-model="userLogin.yanzheng"></el-input> <el-image
					style="width: 100px; height: 30px;position: absolute;top:5px;margin-left:10px;"
					src="" fit="fit"></el-image> </el-form-item> </el-form>
				<center>
