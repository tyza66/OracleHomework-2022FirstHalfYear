...
%>
	<div id="app">
		...
		<div class="righttab">
			...
			</el-table-column> <el-table-column prop="phone" label="手机号"> </el-table-column> <el-table-column
				prop="name" label="姓名"> </el-table-column> <el-table-column
				prop="age" label="年龄"> </el-table-column> <el-table-column
				prop="sex" label="性别"> </el-table-column> <el-table-column
				prop="way" label="行动轨迹"> </el-table-column> <el-table-column
				prop="hs" label="核酸结果"> </el-table-column> <el-table-column
				prop="member" label="身份"> </el-table-column> <el-table-column
